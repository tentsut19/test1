...
/*Custom*/
!function(bull5i,$,undefined){var jqXHR=null,success_timeout=5e3,default_texts={error_ajax_request:"An AJAX error occured!"},default_alert_classes={success:"alert-success",error:"alert-danger",warning:"alert-warning",info:"alert-info"},default_alert_icons={success:"fa-check-circle",error:"fa-times-circle",warning:"fa-exclamation-triangle",info:"fa-info-circle"};bull5i.success_timeout=success_timeout,bull5i.texts="undefined"!=typeof bull5i.texts?$.extend(default_texts,bull5i.texts):default_texts,bull5i.alert_classes="undefined"!=typeof bull5i.alert_classes?$.extend(default_alert_classes,bull5i.alert_classes):default_alert_classes,bull5i.alert_icons="undefined"!=typeof bull5i.alert_icons?$.extend(default_alert_icons,bull5i.alert_icons):default_alert_icons,bull5i.onBeforeSend==undefined&&(bull5i.onBeforeSend=function(e,t){e&&(e.css("display","block"),setTimeout(function(){e.addClass("in")},0)),$("fieldset",t).attr("disabled",!0)}),bull5i.onComplete==undefined&&(bull5i.onComplete=function(e,t){function a(){e.css("display","none")}e&&(e.removeClass("in"),$.support.transition&&e.hasClass("fade")?e.one($.support.transition.end,a).emulateTransitionEnd(500):a()),$("fieldset",t).attr("disabled",!1)}),bull5i.display_alert==undefined&&(bull5i.display_alert=function(e,t,a,o,n){var r,o=o!=undefined?o:1e4,n=n!=undefined?n:!0,i=e||$("#alerts"),s=[];t&&i.length&&(n&&(s=$.map($(".alert",i),function(e){var t=$.Deferred();return $(e).alert("close").on("closed.bs.alert",function(){t.resolve()}),t.promise()})),$.when.apply(null,s).done(function(){a in bull5i.alert_classes||(a="error"),r=$("<div/>",{"class":"alert "+bull5i.alert_classes[a]+" fade"}).html(t).prepend($("<i/>",{"class":"fa "+bull5i.alert_icons[a]})).prepend($("<button/>",{type:"button","class":"close","data-dismiss":"alert","aria-hidden":"true"}).html("&times;")),r=r.appendTo(i),setTimeout(function(){r.addClass("in")},0),o&&setTimeout(function(){r.alert("close")},o)}))}),bull5i.display_alerts==undefined&&(bull5i.display_alerts=function(e,t,a){var t=t!=undefined?t:!0,o=o!=undefined?o:$("#alerts");e&&$.each(e,function(e,o){"object"==typeof o?$.each(o,function(o,n){n&&(bull5i.display_alert(a,n,e,"success"==e?bull5i.success_timeout:0,t),t=!1)}):o&&(bull5i.display_alert(a,o,e,"success"==e?bull5i.success_timeout:0,t),t=!1)})}),bull5i.observable_object_methods=function(){this.hasError=function(){var e=this,t=!1;for(var a in e)ko.isObservable(e[a])&&"function"==typeof e[a].hasError&&(t|=e[a].hasError());return t},this.applyErrors=function(e){var t=this;for(var a in t)ko.isObservable(t[a])&&("function"==typeof t[a].applyErrors?t[a].applyErrors(e.hasOwnProperty(a)?e[a]:{}):("function"==typeof t[a].hasError&&ko.isWriteableObservable(t[a].hasError)&&t[a].hasError(e.hasOwnProperty(a)),"function"==typeof t[a].errorMsg&&e.hasOwnProperty(a)&&ko.isWriteableObservable(t[a].errorMsg)&&t[a].errorMsg(e[a])))},this.updateValues=function(e){var t=this;for(var a in t)ko.isWriteableObservable(t[a])&&e.hasOwnProperty(a)&&("function"==typeof t[a].updateValues?t[a].updateValues(e[a]):$.isArray(t[a]())?window&&window.console&&window.console.log&&window.console.log("Observable Array '"+a+"' missing updateValues method"):t[a](e[a]))}},Number.prototype.round=function(e){return+(Math.round(this+"e+"+e)+"e-"+e)},ko.extenders.hasError=function(e,t){var a=$.extend({check:!0,context:this},t);return e.hasError=ko.computed(function(){var t=!1;return a.check&&$.isArray(e())&&ko.utils.arrayForEach(e(),function(e){"function"==typeof e.hasError&&(t|=e.hasError())}),t}).extend({notify:"always"}),e},ko.extenders.applyErrors=function(e,t){var a=($.extend({context:this},t),function(e,t,a){"function"==typeof e.applyErrors?e.applyErrors(t?a:{}):("function"==typeof e.hasError&&ko.isWriteableObservable(e.hasError)&&e.hasError(t),"function"==typeof e.errorMsg&&ko.isWriteableObservable(e.errorMsg)&&e.errorMsg(t?a:""))});return e.applyErrors=function(t){ko.isObservable(e)&&($.isArray(e())?"function"==typeof e.findByKey&&"function"==typeof e.keys?$.each(e.keys(),function(o,n){a(e.findByKey(n),t.hasOwnProperty(n),t.hasOwnProperty(n)?t[n]:{})}):$.each(e(),function(e,o){a(o,t.hasOwnProperty(e),t.hasOwnProperty(e)?t[e]:{})}):a(e(),t?!0:!1,t?t:{}))},e},ko.extenders.updateValues=function(e,t){var a=($.extend({context:this},t),function(e,t){"function"==typeof e.updateValues?e.updateValues(t):ko.isWriteableObservable(e)&&($.isArray(e())?window&&window.console&&window.console.log&&window.console.log("Observable Array missing updateValues method",e()):e(t))});return e.updateValues=function(t){ko.isObservable(e)&&($.isArray(e())?"function"==typeof e.findByKey&&"function"==typeof e.keys?$.each(e.keys(),function(o,n){t.hasOwnProperty(n)&&a(e.findByKey(n),t[n])}):$.each(e(),function(e,o){t.hasOwnProperty(e)&&a(o,t[e])}):a(e(),t))},e},ko.extenders.validate=function(e,t){var a=this,o=$.extend(!0,{message:"",context:a},t,{target:e});return e.validate=o.method=o.method!=undefined&&"function"==typeof o.method?$.proxy(o.method,o):$.proxy($.noop,o),e.hasError=ko.observable(!1).extend({notify:"always"}),e.errorMsg=ko.observable("").extend({notify:"always"}),o.method(e()),e.subscribe(o.method),e},ko.extenders.required=function(e,t){function a(e){this.target.hasError(e?!1:!0),this.target.errorMsg(e?"":this.message)}return t.target=e,t.method=t.method!=undefined&&"function"==typeof t.method?$.proxy(t.method,t):$.proxy(a,t),t.message=t.message!=undefined&&"string"==typeof t.message?t.message:"This field is required",ko.extenders.validate.call(this,e,t)},ko.extenders.numeric=function(e,t){var a=ko.computed({read:e,write:function(a){var o=$.extend({precision:2,context:this},t),n=e(),r=(isNaN(a)?0:parseFloat(+a)).round(o.precision);r!==n?e(r):a!==n&&e.notifySubscribers(r)}}).extend({notify:"always"});return a(e()),a},ko.observableArray.fn.withIndex=function(e){var t=ko.computed(function(){var t=this()||[],a={};return ko.utils.arrayForEach(t,function(t){e?a[ko.utils.unwrapObservable(t[e])]=t:a[t]=t}),a},this);return this.findByKey=function(e){return t()[e]},this.keys=function(){return Object.keys(t())},this},ko.bindingHandlers.tooltip={init:function(e,t){var a=ko.utils.unwrapObservable(t()),o={};ko.utils.extend(o,ko.bindingHandlers.tooltip.options),ko.utils.extend(o,a),$(e).tooltip(o),ko.utils.domNodeDisposal.addDisposeCallback(e,function(){$(e).tooltip("destroy")})},options:{trigger:"hover"}},ko.bindingHandlers.typeahead={init:function(e,t,a){{var o=t(),n={};ko.utils.unwrapObservable(a()).value}ko.utils.extend(n,ko.bindingHandlers.typeahead.options),ko.utils.extend(n,o.options),$(e).typeahead(n,o.datasets)},options:{hint:!0,highlight:!0}},$(function(){function sticky_nav(){var e=$win.scrollTop();navTop!=$(".navbar-placeholder").offset().top&&(navTop=$(".navbar-placeholder").offset().top),e>=navTop&&!isFixed?(isFixed=1,$nav_ph.length&&$nav_ph.height($nav_ph.outerHeight()),$nav.addClass("navbar-fixed-top")):navTop>=e&&isFixed&&(isFixed=0,$nav_ph.length&&$nav_ph.height(""),$nav.removeClass("navbar-fixed-top"))}function ajax_success(data){var dismiss=!0;if(data){if(this.vm&&data.values&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].updateValues&&bull5i.view_models[this.vm].updateValues(data.values),this.vm&&bull5i.view_models&&bull5i.view_models[this.vm]&&bull5i.view_models[this.vm].applyErrors&&bull5i.view_models[this.vm].applyErrors(data.errors?data.errors:{}),data.msg&&bull5i.display_alert&&(bull5i.display_alert(this.alerts,data.msg,"success",success_timeout),dismiss=!1),bull5i.display_alerts(data.alerts,dismiss,this.alerts),data.callback)try{eval(data.callback)}catch(e){}data.reload?window.location.reload(!0):data.url&&(window.location=data.url),this.dfd&&this.dfd.resolve()}}function ajax_fail(e,t,a){bull5i.display_alert&&bull5i.display_alert(this.alerts,bull5i.texts.error_ajax_request,"error",0),this.dfd&&this.dfd.reject(),window&&window.console&&window.console.log&&window.console.log(e,t,a)}function ajax_always(){bull5i.onComplete(this.overlay,this.context),this.btn&&(this.btn.data("loading-text")?this.btn.button("reset"):this.btn.prop("disabled",!1))}var $win=$(window),$nav_ph=$(".navbar-placeholder"),$nav=$("#bull5i-navbar"),navTop=$("#bull5i-navbar").length&&$("#bull5i-navbar").offset().top,isFixed=0;sticky_nav(),$win.on("scroll",sticky_nav),window.prettyPrint&&prettyPrint(),$("body").on("click",".modal-footer .cancel",function(){jqXHR&&jqXHR.abort()}).on("click","#save",function(){var e=$($(this).data("form"));e&&e.submit()}).on("click","#apply",function(e){var t=this,a={self:t,btn:$(this),form:$($(this).data("form")),url:$(this).data("url"),alerts:$("#alerts"),context:$($(this).data("context")),overlay:$($(this).data("overlay")),vm:$(this).data("vm")};e.preventDefault(),a.url&&$.ajax({type:"POST",url:a.url,dataType:"json",data:a.form.serialize(),beforeSend:function(){bull5i.onBeforeSend(a.overlay,a.context),a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0)}}).done($.proxy(ajax_success,a)).fail($.proxy(ajax_fail,a)).always($.proxy(ajax_always,a))}).on("click","#delete",function(e){var t=!1,a={url:$(this).data("url"),dfd:$.Deferred()};e.preventDefault(),a.url&&($("#confirmDelete").length?($("#confirmDelete").modal("show"),$("#confirmDelete button.delete").click(function(){$("#confirmDelete").modal("hide"),t=!0}),$("#confirmDelete").on("hidden.bs.modal",function(){t?a.dfd.resolve():a.dfd.reject()})):(t=!0,a.dfd.resolve()),$.when(a.dfd).done(function(){t&&(window.location=a.url)}))}).on("click","#upgrade,#fix-db",function(e){var t=this,a={self:t,btn:$(this),form:$($(this).data("form")),url:$(this).data("url"),alerts:$("#alerts"),context:$($(this).data("context")),overlay:$($(this).data("overlay"))};e.preventDefault(),a.url&&$.ajax({type:"POST",url:a.url,dataType:"json",beforeSend:function(){bull5i.onBeforeSend(a.overlay,a.context),a.btn.data("loading-text")?a.btn.button("loading"):a.btn.prop("disabled",!0)}}).done($.proxy(ajax_success,a)).fail($.proxy(ajax_fail,a)).always(function(e,t,o){ajax_always.call(a,e,t,o),e&&e.success?a.btn.remove():a.btn.data("loading-text")?a.btn.button("reset"):a.btn.prop("disabled",!1)})}).on("click","#legal_notice",function(e){e.preventDefault(),$($(this).attr("data-modal")).modal({show:!0,keyboard:!0})}).on("click","a.external-tab-link",function(e){var t=$(this).attr("data-target");e.preventDefault(),t&&(tabs=t.split(","),$.each(tabs,function(e,t){$("[href="+t+"]").trigger("click")}))}).on("click","button.purchase",function(){var e=$(this).closest("tr.srvc"),t=e.find(".service").text(),a=e.find(".code").text(),o=e.find(".currency").text(),n=parseFloat(e.find(".price").text());t&&a&&o&&n&&window.open("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=support@opencart.ee&item_name="+t+"&item_number="+a+"&amount="+n+"&currency_code="+o+"&button_subtype=services&no_note=0&bn=OCEE_BuyNow_WPS_EE")}).on("click",".add-module",function(e){var t=ko.contextFor(this).$root;e.preventDefault(),t.addModule()}).on("click",".remove-module",function(e){var t=ko.dataFor(this),a=ko.contextFor(this).$parent;e.preventDefault(),a.deleteModule(t)}),$("#alerts .alert.alert-success").each(function(){var e=$(this);setTimeout(function(){e.alert("close")},8e3)})})}(window.bull5i=window.bull5i||{},jQuery);
