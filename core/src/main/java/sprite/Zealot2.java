...
public class Zealot2 extends UIScreen{
    ...
    public Zealot2(final World world, final float x_px, final float y_px){
        sprite = SpriteLoader.getSprite("images/water.json");
        ...
        sprite.layer().addListener(new Pointer.Adapter(){
            ...
            public void onPointerEnd(Pointer.Event event) {
                body.applyLinearImpulse(new Vec2(0f,40f), body.getPosition());
            }
        });
    ...
    private Body initPhysicsBody(World world, float x, float y) {
        ...
        shape.setAsBox(66 * GameScreen.M_PER_PIXEL / 2,
...
*/
    ...
    public void update(int delta) {
        ...
        body.applyLinearImpulse(new Vec2(0f,-0.6751234f), body.getPosition());
